...
public class DummyIsoServer implements ISORequestListener {
	...
	private void sendPaymentPrepaid(ISOSource source, ISOMsg m) {
		...
		try {
			...
			m.set(48, "211134035190445311010406195 0JUNITA JULIANA KAREL     R1  0000022003131101123            0158400000000000000000000000827361WX4048ZYA6596ZX9ZY94ZY9XXV073521V00KF41687966284763BC803070P00000000200000000002000000000020000000000200009091002000000000020000090909002000000673051122481121747103222060Informasi Hubungi Call Center 123 Atau hubungi PLN Terdekat");
			m.setPackager(new ISO87APackager());
			source.send(m);
		} catch (ISOException e) {
			e.printStackTrace();
